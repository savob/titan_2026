...
There were some hardware changes from 2022 to 2026, these are all principally in the embedded "sensor" system which will need some changes to be made to the TITAN system. For a complete list of changes refer to the `README.md` files for the [main board](../hardware/titan_2026_rev_a/README.md#changes-from-2022) and [wheel board](../hardware/wheel_2026_rev_a/README.md#changes-from-2022) as this will summarize the ones that need to be acted on. These will be sorted into sections based on descending importance to complete.
...
- **Get smaller batteries.** The ones we used in 2022 were 2200&nbsp;mAh or more 3S LiFePO4 if I recall correctly, this is far over sized and needless wight in my opinion. As mentioned in the [operation guide](./OPERATION.md#batteries-and-power), a _fully charged_ 1000&nbsp;mAh 3S LiFePO4 battery is sufficient to run any of the vision systems for around an hour which will suffice for a heat.

...
Original library from [HardwareLevel](https://github.com/HardwareLevel/stm32_hal_nrf24_library), I modified it to use a struct for configuration so I can use multiple radio instances.
